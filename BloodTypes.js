function canGiveBlood(blood1, blood2) {
    if (blood1 == "A+") {
        ...
        if (blood2 == "AB+" || blood2 == "AB-" || blood2 == "A+" || blood2 == "A-") {
            return "True"
        } else {
            return "False"
        }
        ...
        if (blood2 == "O+" || blood2 == "AB+" || blood2 == "A+" || blood2 == "B+") {
            return "True"
        } else {
            return "False"
        }
    } else if (blood1 == "O-") {
        if (blood2 == "O+" || blood2 == "O-" || blood2 == "AB+" || blood2 == "AB-" || blood2 == "B+" || blood2 == "B-" || blood2 == "A+" || blood2 == "A-") {
            return "True"
        }
    }
}
